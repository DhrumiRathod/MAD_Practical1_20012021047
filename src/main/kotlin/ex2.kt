...
fun main(){
    var l1=Laptop("Lenovo",8,80000,"8Core","16GB","512")
    var l2=Laptop("HP",5,90000,"8Core","16GB","256")
    var l3=Laptop("APPLE",3,71000,"8Core","4GB","512")
    var l4=Laptop("DELL",1,210000,"8Core","8GB","256")
    var l5=Laptop("ASUS",1,24500,"8Core","16GB","512")
}