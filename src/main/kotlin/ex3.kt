...
fun main(){
    var s1=Student("Dhrumi","Rathod",19,20012021047,"IT","C","AB9")
    var s2=Student("keyuri","Rabadia",20,20012011045,"IT","A","AB7")
    var s3=Student("Kiran","Patel",20,20012021034,"IT","C","AB9")
    var s4=Student("Rutvi","Patel",19,20012021055,"CE","C","AB10")
    var s5=Student("Khushi","Patel",20,20012021033,"CE","A","AB11")
