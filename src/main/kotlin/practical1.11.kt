...
fun main() {
    val firstMatrix = Matrix(arrayOf(intArrayOf(3, -8, 5), intArrayOf(3, 0, 4)), 2, 3)
    val secondMatrix = Matrix(arrayOf(intArrayOf(2, 9), intArrayOf(-3, 8), intArrayOf(0, 4)), 3, 2)
    val secondMatrix1 = Matrix(arrayOf(intArrayOf(1, 3), intArrayOf(4, 0), intArrayOf(5, 4)), 3, 2)
